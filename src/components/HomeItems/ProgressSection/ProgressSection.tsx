...
const ProgressSection = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center ">
      <div className="mx-16 w-[80%] grid-rows-3 [perspective:900px] lg:mx-0 lg:grid lg:grid-cols-5 lg:grid-rows-3 lg:gap-8 xl:w-[66rem]">
        <div
          onMouseEnter={() => setDashDetails(true)}
          onMouseLeave={() => setDashDetails(false)}
          className="relative mb-16 transition-all duration-500 [transform:rotate3d(0,_-1,_0.1,_20deg)_translate(-5%)] hover:[transform:rotate3d(0,_-1,_0.1,_20deg)_translate(-5%)] sm:[transform:rotate3d(0,_-1,_0.1,_30deg)_translate(-8%)] lg:col-span-3 lg:col-start-3 lg:row-span-2 lg:row-start-1 lg:mb-0">
