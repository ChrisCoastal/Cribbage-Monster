    ...
    <>
      <div className="mt-32 mb-16 flex justify-center px-4 text-stone-50 sm:px-12">
        <div className="max-w-[40rem]">
          ...
          <p className="mb-2">
            Each hand has a dealer. At the start of the hand, each player is dealt 6 cards. After
            each hand is played the deal alternates between the players.
          </p>
          ...
          <p className="mb-2">
            After the starter is turned, the non-dealer lays one of their cards face up on the
            table. The dealer similarly exposes a card, then non-dealer again, and so on - the hands
            are exposed card by card, alternately except for a Go, as noted below. Each player keeps
            their cards separate from those of their opponent. As each person plays, the running
            count of the cards is updated.
          </p>
          <SubHeading className="mt-8">Go!</SubHeading>
          <p className="mb-2">
            During play, the running total of cards may never be carried beyond 31. If a player
            cannot add another card without exceeding 31, it is a Go and the opponent pegs 1. Before
            gaining the Go, the opponent must first lay down any additional cards possible without
            exceeding 31. Besides the point for Go, they may then score any additional points that
            can be made through pairs and runs (described later). If a player reaches exactly 31,
            they peg two instead of one for Go. Once the player has played all cards possible, play
            begins with the other player and the count starting back at zero. All possible scoring
            combinations are also reset (for example, a run cannot be made using cards played before
            and after the Go - the Go has interrupted the sequence).
          </p>
          <SubHeading className="mt-8">Pegging</SubHeading>
          <p className="mb-2">
            The object in play is to score points by pegging. In addition to a Go, a player may
            score for the following combinations:
          </p>
          ...
          <p className="mb-2">
            ...
            suits, but go strictly by rank; to illustrate: 9, 10, J, or J, 9, 10 is a run but 9, 10,
            Q is not.)
          </p>
          <p className="mb-2">
            It is important to keep track of the order in which cards are played to determine
            whether what looks like a sequence or a run has been interrupted Example: Cards are
            played in this order: 8, 7, 7, 6. The dealer pegs 2 for 15, and the opponent pegs 2 for
            pair, but the dealer cannot peg for run because of the extra seven (foreign card) that
            has been played. Example: Cards are played in this order: 9, 6, 8, 7. The dealer pegs 2
            for fifteen when he or she plays the six and pegs 4 for run when he plays the seven (the
            6, 7, 8, 9 sequence). The cards were not played in sequential order, but they form a
          ...
          <p className="mb-2">
            Flush. Four cards of the same suit in hand scores 4. If the starter is also the same
            suit, the flush scores 5 points. There is no count for four card flush in the crib. All
            4 cards in the crib and the starter must be the same suit.
          </p>
          <p className="mb-2">
